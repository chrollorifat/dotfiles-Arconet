...
FLOAT_BTN               : HTML  = "<div class='ml-10 turquoise-hover cursor-pointer' onclick='addFloatingNote({nid})'><i class='fa fa-window-maximize'></i></div>" if config["results.showFloatButton"] else ""
NID_BTN                 : HTML  = "<div class='ml-10 turquoise-hover cursor-pointer flex-row bold' style='align-items: center; font-size: 10px;' onclick='pycmd(\"siac-copy-to-cb {nid}\")'>NID</div>" if config["results.showIDButton"] else ""
CID_BTN                 : HTML  = "<div class='ml-10 turquoise-hover cursor-pointer flex-row bold' style='align-items: center; font-size: 10px;' onclick='pycmd(\"siac-copy-cid-to-cb {nid}\")'>CID</div>" if config["results.showCIDButton"] else ""
