...
exports.TagCompletionProvider = exports.TAG_REGEX = void 0;
...
class TagCompletionProvider {
    ...
    provideCompletionItems(document, position) {
        ...
        const requiresAutocomplete = cursorPrefix.match(exports.TAG_REGEX) && !cursorPrefix.match(link_completion_1.SECTION_REGEX);
