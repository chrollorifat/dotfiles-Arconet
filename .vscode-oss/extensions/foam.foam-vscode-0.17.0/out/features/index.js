...
const navigation_provider_1 = __importDefault(require("./navigation-provider"));
const wikilink_diagnostics_1 = __importDefault(require("./wikilink-diagnostics"));
exports.features = [
    navigation_provider_1.default,
    wikilink_diagnostics_1.default,
