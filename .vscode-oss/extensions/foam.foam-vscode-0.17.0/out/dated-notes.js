...
function getDailyNotePath(configuration, date) {
    ...
    if (path_1.isAbsolute(dailyNoteDirectory)) {
        return uri_1.URI.joinPath(uri_1.URI.file(dailyNoteDirectory), dailyNoteFilename);
    }
    else {
        return uri_1.URI.joinPath(vsc_utils_1.fromVsCodeUri(vscode_1.workspace.workspaceFolders[0].uri), dailyNoteDirectory, dailyNoteFilename);
    }
}
