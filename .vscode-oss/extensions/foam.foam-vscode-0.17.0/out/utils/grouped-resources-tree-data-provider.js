...
class GroupedResourcesTreeDataProvider {
    ...
    isMatch(uri) {
        return micromatch_1.default.isMatch(uri_1.URI.toFsPath(uri), this.exclude);
    }
...
class UriTreeItem extends vscode.TreeItem {
    constructor(uri, options = {}) {
        var _a, _b, _c;
        super((_a = options === null || options === void 0 ? void 0 : options.title) !== null && _a !== void 0 ? _a : uri_1.URI.getBasename(uri), options.collapsibleState);
        this.uri = uri;
