...
# Page E
`;
const createNoteFromMarkdown = (path, content) => markdown_provider_1.createMarkdownParser([]).parse(uri_1.URI.file(path), content);
describe('Markdown loader', () => {
    it('Converts markdown to notes', () => {
        ...
        expect(workspace
            .list()
            .map(n => n.uri)
            .map(slug_1.uriToSlug)
            .sort()).toEqual(['page-a', 'page-b', 'page-c', 'page-d', 'page-e']);
    });
    it('Ingores external links', () => {
        const note = createNoteFromMarkdown('/path/to/page-a.md', `
...
`);
    ...
    it('Parses internal links correctly', () => {
        const note = createNoteFromMarkdown('/path/to/page-a.md', 'this is a [link to page b](../doc/page-b.md)');
    ...
    it('Parses links that have formatting in label', () => {
        const note = createNoteFromMarkdown('/path/to/page-a.md', 'this is [**link** with __formatting__](../doc/page-b.md)');
        expect(note.links.length).toEqual(1);
        const link = note.links[0];
        expect(link.type).toEqual('link');
    ...
    it('Parses backlinks with an alias', () => {
        const note = createNoteFromMarkdown('/path/to/page-a.md', 'this is [[link|link alias]]. A link with spaces [[other link | spaced]]');
    ...
    it('Skips wikilinks in codeblocks', () => {
        const noteA = createNoteFromMarkdown('/dir1/page-a.md', `
...
describe('Note Title', () => {
    it('should initialize note title if heading exists', () => {
        const note = createNoteFromMarkdown('/page-a.md', `
# Page A
this note has a title
    ...
    it('should default to file name if heading does not exist', () => {
        const note = createNoteFromMarkdown('/page-d.md', `
This file has no heading.
    ...
    it('should give precedence to frontmatter title over other headings', () => {
        const note = createNoteFromMarkdown('/page-e.md', `
---
title: Note Title
date: 20-12-12
---
...
# Other Note Title
    ...
    it('should support numbers', () => {
        ...
        const note3 = createNoteFromMarkdown('/157.md', `
---
title: 159
---
...
`);
    ...
    it('should not break on empty titles (see #276)', () => {
        const note = createNoteFromMarkdown('/Hello Page.md', `
#
...
# Other Note Title`);
    ...
    it('should parse empty frontmatter', () => {
        const note = createNoteFromMarkdown('/page-f.md', `
---
---
...
describe('wikilinks definitions', () => {
    it('can generate links without file extension when includeExtension = false', () => {
        ...
        const noExtRefs = markdown_provider_1.createMarkdownReferences(workspace, noteA.uri, false);
    ...
    it('can generate links with file extension when includeExtension = true', () => {
        ...
        workspace
            ...
            .set(createNoteFromMarkdown('/dir1/page-b.md', pageB))
            .set(createNoteFromMarkdown('/dir1/page-c.md', pageC));
        const extRefs = markdown_provider_1.createMarkdownReferences(workspace, noteA.uri, true);
...
describe('Sections plugin', () => {
    it('should find sections within the note', () => {
        const note = createNoteFromMarkdown('/dir1/page-a.md', `
# Section 1
...
describe('parser plugins', () => {
    ...
    const parser = markdown_provider_1.createMarkdownParser([testPlugin]);
