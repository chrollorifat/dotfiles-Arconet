...
local config = {
    ...
    deck_name = "Mining Deck", -- name of the deck for new cards
    model_name = "JP Mining Note", -- Tools -> Manage note types
    sentence_field = "Sentence",
    secondary_field = "AltDisplaySentence",
    ...
    miscinfo_field = "Comment", -- misc notes and source information field
    ...
    vocab_audio_field = "WordAudio", -- target word audio
}
